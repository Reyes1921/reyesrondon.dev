  ...
  return (
    <article className="flex flex-col items-center justify-center">
      <div className="px-10 py-5 w-full">
        ...
        <div className="">
          <h3 className="text-center text-primary text-xl md:text-3xl font-bold mb-4 mt-5">
            Frontend
          </h3>
          ...
          <div className="flex flex-col md:flex-row justify-between">
            <div>
              <h3 className="text-center text-primary text-xl md:text-3xl font-bold mb-4 mt-5 pr-2">
                Backend
              </h3>
              <Atropos className="my-atropos mt-5" rotateTouch="scroll-y">
